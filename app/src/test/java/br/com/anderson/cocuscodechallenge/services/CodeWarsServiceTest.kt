...
class CodeWarsServiceTest {
    ...
    fun `test user response success full data`() {
        ...
        assertThat(user.ranks?.languages?.language).containsKey("coffeescript")
        assertThat(user.ranks?.languages?.language?.get("coffeescript")?.color).isEqualTo("blue")
        assertThat(user.ranks?.languages?.language?.get("coffeescript")?.rank).isEqualTo(-4)
        assertThat(user.ranks?.languages?.language?.get("coffeescript")?.name).isEqualTo("4 kyu")
        assertThat(user.ranks?.languages?.language?.get("coffeescript")?.score).isEqualTo(870)
